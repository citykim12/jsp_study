...
<script type="text/javascript">
  function cBtnInsert(){
	  ...
	  $.ajax({
			...
			type:"post",
			data:{
				id:"${session_id}", //문자형에는 ""붙임
				bid:${bid},         // 숫자에는 안붙임
				cpw:$("#cpw").val(),
				ccontent:$("#ccontent").val()
			},
			success:function(data){   //map.eventVo
			  var html;
			  alert(data.eventVo.cno);
			  alert(data.eventVo.id);
			  alert(data.eventVo.ccontent);
			  html = html + '<ul id="'+data.eventVo.cno +'">';
			  html = html + '<li class="name">'+ data.eventVo.id +'<span>[ '+data.eventVo.cdate +' ]</span></li>';
			  html = html + '<li class="txt">'+data.eventVo.ccontent+'</li>';
			 
				  html = html + '<li class="btn">';
				  html = html + '<a href="#" class="rebtn">수정</a>';
				  html = html + '<a href="#" class="rebtn">삭제</a>';
				  html = html + '</li>';
			...
			<div id="contents">
				<div id="mypage">
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								<p class="txt">총 <span class="orange" id="count">${count}</span> 개의 댓글이 달려있습니다.</p>
							...
							<li class="btn"><a href="#" onclick="cBtnInsert()" class="replyBtn">등록</a></li>
						</ul>
					...
					<div class="replyBox">
						...
						<ul id="${eventVo.cno }">
							...
							<c:if test="${session_id == eventVo.id }">
								<li class="btn">
									<a href="#" class="rebtn">수정</a>
									<a href="#" class="rebtn">삭제</a>
								</li>
